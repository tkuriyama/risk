...
{
	if (region.ad.K === region.an.K)
	{
		return 'on line ' + region.ad.K;
	}
	return 'on lines ' + region.ad.K + ' through ' + region.an.K;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { bd: 'hidden', a2: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { bd: 'mozHidden', a2: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { bd: 'msHidden', a2: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { bd: 'webkitHidden', a2: 'webkitvisibilitychange' }
		: { bd: 'hidden', a2: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ap: fragment, at: host, aC: path, aE: port_, aH: protocol, aI: query};
	});
...
var $author$project$Show$render = F3(
	function (w, h, m) {
		...
		return _Utils_ap(
			_List_fromArray(
				[
					A3($author$project$Show$showText, w, h, t)
				]),
